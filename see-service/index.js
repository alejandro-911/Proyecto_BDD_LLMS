...
const PG_CHANNEL = process.env.PG_CHANNEL || "reservas_changes";
...
async function createListenerClient() {
  ...
  pg.on("notification", (msg) => {
    ...
    const eventName = payload.op.toLowerCase(); // "insert" | "update" | "delete"
    console.log(`${eventName} en reservas (id=${payload.id_reserva})`);
